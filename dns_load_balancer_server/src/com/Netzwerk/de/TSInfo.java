...
/**
*
* Beschreibung eines Terminalservers mit der Auslastung, dem Namen, dem Typ und der IP
*
...
/**
 * Dem Konstruktor werden die Paramter übergeben um diese in die Klassenattribute hinein zu schreiben
 * 
 * @param piAuslastung gibt die Auslastung als Int an
 * @param piTyp gibt den Typ als Int an
 * @param psIP gibt die IP als String an
 * @param psName gibt den Namen als String an
 */
